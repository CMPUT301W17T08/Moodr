...
public class MapsLatestActivity extends AppCompatActivity  implements
    ...
    private ArrayList<Mood> latestFilteredMoods;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps_latest);
        ...
        SupportMapFragment mapFragment =
                (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.latest_map);
        mapFragment.getMapAsync(this);


        Intent intent = getIntent();
        // Get the list of the filtered moods from LatestActivity
        latestFilteredMoods = (ArrayList<Mood>) intent.getSerializableExtra("filteredList");

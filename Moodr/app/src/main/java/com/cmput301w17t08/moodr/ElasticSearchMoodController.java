...
//            }
    ...
    public static class GetNearByMoodsTask extends AsyncTask<Double, Void, ArrayList<Mood>> {
        ...
        protected ArrayList<Mood> doInBackground(Double... search_parameters) {
            ...
            String query = "{ \"size\" : 0, \"aggs\" : { \"group\" : { \"terms\" : { \"field\" : \"owner\", \"size\" : 0 }, \"aggs\" : { \"group_docs\" : { \"terms\" : { \"field\" : \"date\", \"order\" : { \"_term\" : \"desc\" }, \"size\" : 1 }, \"aggs\" : { \"geof\" : { \"filter\" : { \"geo_distance\" : { \"distance\" : \"5km\", \"distance_type\" : \"arc\", \"location\" : { \"lat\" : " + current_latitude + ", \"lon\" : " + current_longitude + " }}}, \"aggs\" : { \"top_hits_geo\" : { \"top_hits\" : {}}}}}}}}}}";

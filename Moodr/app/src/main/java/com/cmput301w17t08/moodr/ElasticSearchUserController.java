...
public class ElasticSearchUserController {
    ...
    public static class UpdateUserTask extends AsyncTask<User, Void, Void> {
        ...
        protected Void doInBackground(User... user) {
            ...
            // first delete user
            String query = "{\"query\": {\"bool\": {\"must\": {\"term\": {\"name\": \""+ name +"\"}}}}}";
            ...
            try {
                ...
                Log.i("Error", "Unable to deleting user");
            }

            //add again.
            Index index = new Index.Builder(user[0]).index("cmput301w17t8").type("user").build();
